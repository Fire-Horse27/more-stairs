...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    private static final List<Item> MATERIAL = List.of(Items.OAK_PLANKS, Items.SPRUCE_PLANKS, Items.BIRCH_PLANKS,
            ...
            Items.BAMBOO_PLANKS, Items.CRIMSON_PLANKS, Items.WARPED_PLANKS, Items.BAMBOO_MOSAIC, Items.PALE_OAK_PLANKS, Items.STONE,
            ...
            Items.DARK_PRISMARINE, Items.RESIN_BRICKS, Items.NETHER_BRICKS, Items.RED_NETHER_BRICKS, Items.BLACKSTONE,
    ...
    private static final List<Item> STAIR = List.of(Items.OAK_STAIRS, Items.SPRUCE_STAIRS, Items.BIRCH_STAIRS,
            ...
            Items.BAMBOO_STAIRS, Items.CRIMSON_STAIRS, Items.WARPED_STAIRS, Items.BAMBOO_MOSAIC_STAIRS, Items.PALE_OAK_STAIRS, Items.STONE_STAIRS,
            ...
            Items.PRISMARINE_BRICK_STAIRS, Items.DARK_PRISMARINE_STAIRS, Items.RESIN_BRICK_STAIRS, Items.NETHER_BRICK_STAIRS,
        ...
        return new RecipeGenerator(registries, exporter) {
            ...
            public void generate() {
                for(int i = 0; i < WOODCOUNT; i++) {
                    createShaped(RecipeCategory.BUILDING_BLOCKS, STAIR.get(i), 6)
                            .pattern("#  ")
                            .pattern("## ")
                            .pattern("###")
                            .group("wooden_stairs")
                ...
                for(int i = WOODCOUNT; i < WOODCOUNT + 38; i++) {
                    if(i == WOODCOUNT + 36) {
                        createShaped(RecipeCategory.BUILDING_BLOCKS, STAIR.get(i), 6)
                                .pattern("#  ")
                                .pattern("## ")
                ...
                for(int i = WOODCOUNT + 38; i < WOODCOUNT + 42; i++) {
                    createShaped(RecipeCategory.BUILDING_BLOCKS, STAIR.get(i), 6)
                            .pattern("#  ")
                            .pattern("## ")
                            .pattern("###")
                ...
                for(int i = WOODCOUNT + 42; i < WOODCOUNT + 46; i++) {
                    createShaped(RecipeCategory.BUILDING_BLOCKS, STAIR.get(i), 6)
                            .pattern("#  ")
                            .pattern("## ")
                            .pattern("###")
                    ...
                    createShapeless(RecipeCategory.BUILDING_BLOCKS, STAIR.get(i))
